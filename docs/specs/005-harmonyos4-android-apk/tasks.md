...
- [x] T561 Android：为正文图片/视频增加长按“从正文删除”确认，保留 Vault 附件；为末尾媒体
  提供后续输入行和轻点后置光标行为，补充渲染、删除桥接与序列化边界测试（FR-534）。
...
当前 `0.5.2` / `versionCode 11` 源码已在 T559 变更后通过 176 项 Android 单测和 fresh debug
